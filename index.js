...
var args =
    require('minimist')(process.argv.slice(2), {base: 'string', boolean: ['semantic-diagnostics']});
try {
  args.semanticDiagnositcs = args['semantic-diagnostics'] || false;
  delete args['semantic-diagnostics'];
